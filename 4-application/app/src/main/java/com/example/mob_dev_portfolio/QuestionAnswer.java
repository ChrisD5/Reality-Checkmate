...
public class QuestionAnswer {
    ...
    public static String choices[][] ={
            ...
            {"Im happy for them.", "I'mma let you finish, but Beyoncé had one of the best videos of all time!", "I deserve the recognition.", "Extremely upset, I should have won that award."},
